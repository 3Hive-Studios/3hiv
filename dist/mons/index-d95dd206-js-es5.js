(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["index-d95dd206-js"], {
    /***/
    "/yFf":
    /*!******************************************************!*\
    ...
    function L21C(module, exports) {
      ...
      var ETH_DATA_MAX_SIZE = 1024; // Maximum number of bytes that can go in the data field

      var ETH_MSG_MAX_SIZE = 1024; // Maximum number of bytes that can be used in a message signing request
      ...
      module.exports = {
        ...
        ETH_DATA_MAX_SIZE: ETH_DATA_MAX_SIZE,
        ETH_MSG_MAX_SIZE: ETH_MSG_MAX_SIZE,
    ...
    "lGYU":
    /*!*************************************************************!*\
      !*** ./node_modules/bnc-onboard/dist/esm/index-d95dd206.js ***!
      \*************************************************************/

    /*! no static exports found */

    /***/
    function lGYU(module, exports, __webpack_require__) {
    ...
    function pzNo(module, exports, __webpack_require__) {
      ...
      /*! ./util */
      "PLHu"),
          signReqResolver = _webpack_require__5.signReqResolver,
          aes256_decrypt = _webpack_require__5.aes256_decrypt,
          aes256_encrypt = _webpack_require__5.aes256_encrypt,
          parseDER = _webpack_require__5.parseDER,
          checksum = _webpack_require__5.checksum,
          getP256KeyPair = _webpack_require__5.getP256KeyPair,
          getP256KeyPairFromPub = _webpack_require__5.getP256KeyPairFromPub,
          parseLattice1Response = _webpack_require__5.parseLattice1Response,
          toPaddedDER = _webpack_require__5.toPaddedDER;

      var _webpack_require__6 = __webpack_require__(
      /*! ./constants */
      "L21C"),
          ADDR_STR_LEN = _webpack_require__6.ADDR_STR_LEN,
          ENC_MSG_LEN = _webpack_require__6.ENC_MSG_LEN,
          decResLengths = _webpack_require__6.decResLengths,
          deviceCodes = _webpack_require__6.deviceCodes,
          encReqCodes = _webpack_require__6.encReqCodes,
          responseCodes = _webpack_require__6.responseCodes,
          REQUEST_TYPE_BYTE = _webpack_require__6.REQUEST_TYPE_BYTE,
          VERSION_BYTE = _webpack_require__6.VERSION_BYTE,
          messageConstants = _webpack_require__6.messageConstants,
          BASE_URL = _webpack_require__6.BASE_URL;
        ...
        _createClass2(Client, [{
          ...
          value: function _getActiveWallet(cb) {
            ...
            if (forceRefresh !== true && (this.hasActiveWallet() === true || this.isPaired !== true)) {
              ...
              return this._request(param, function (err, res) {
                if (err) {
                  _this18._resetActiveWallets();

                  return cb(err);
                }

                return cb(_this18._handleGetWallets(res));
              });
            }
            ...
            superagent.post(url).timeout(this.timeout).send({
              ...
              if ((parsed.responseCode === responseCodes.RESP_ERR_DEV_BUSY || parsed.responseCode === responseCodes.RESP_ERR_GCE_TIMEOUT) && retryCount > 0) {
                return setTimeout(function () {
                  _this19._request(data, cb, retryCount - 1);
                }, 3000);
              } // If we caugh a `ErrWalletNotPresent` make sure we aren't caching an old ative walletUID


              if (parsed.responseCode === responseCodes.RESP_ERR_WALLET_NOT_PRESENT) _this19._resetActiveWallets(); // If there was an error in the response, return it
          ...
          value: function _handleConnect(res) {
            ...
            var pub = res.slice(off, res.length).toString('hex');
    ...
    function xKF7(module, exports, __webpack_require__) {
      ...
      exports.buildEthereumMsgRequest = function (input) {
        ...
        if (input.protocol === 'signPersonal') {
          var L = (input.signerPath.length + 1) * 4 + constants.ETH_MSG_MAX_SIZE + 4;
          var off = 0;
          ...
          if (payload.length > constants.ETH_MSG_MAX_SIZE) throw new Error("Your payload is ".concat(payload.length, " bytes, but can only be a maximum of ").concat(constants.ETH_MSG_MAX_SIZE)); // Write the payload and metadata into our buffer
      ...
      exports.buildEthereumTxRequest = function (data) {
        try {
          ...
          var useEIP155 = eip155[chainId]; // Hack for metamask, which sends value=null for 0 ETH transactions
          ...
          var txReqPayload = Buffer.alloc(1146);
          ...
          if (dataBytes && dataBytes.length > constants.ETH_DATA_MAX_SIZE) {
            return {
              err: "Data field too large (must be <=".concat(constants.ETH_DATA_MAX_SIZE, " bytes)")
            };
          } // Data
      ...
      function addRecoveryParam(payload, sig, address, chainId, useEIP155) {
        try {
          ...
          var pubkey = secp256k1.ecdsaRecover(rs, sig.v - 27, hash, false).slice(1); // If the first `v` value is a match, return the sig!
...
//# sourceMappingURL=index-d95dd206-js-es5.js.map